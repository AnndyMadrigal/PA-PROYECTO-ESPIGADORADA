...
namespace PA_PROYECTO_ESPIGADORADA.EntityFramework
{
    ...
    public partial class Espiga_DBEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> InsertPurchaseOrder(Nullable<int> supplier_id, string created_by, string details)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("InsertPurchaseOrder", supplier_idParameter, created_byParameter, detailsParameter);
        }
    
        public virtual ObjectResult<ProcessOrder_Result> ProcessOrder(Nullable<int> userId, string paymentMethod, string paymentReference, string notes, string createdBy, string itemsXml)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(int));
            ...
            var itemsXmlParameter = itemsXml != null ?
                new ObjectParameter("ItemsXml", itemsXml) :
                new ObjectParameter("ItemsXml", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ProcessOrder_Result>("ProcessOrder", userIdParameter, paymentMethodParameter, paymentReferenceParameter, notesParameter, createdByParameter, itemsXmlParameter);
        }
    }
}
